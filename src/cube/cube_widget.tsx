...
export function CubeWidget(props: CubeWidgetProps) {
    ...
    const initWebGPU = async () => {
        ...
        canvasRef.width = (props.width || canvasRef.clientWidth) * devicePixelRatio;
        canvasRef.height = (props.height || canvasRef.clientHeight) * devicePixelRatio;
        ...
        const depthTexture = device.createTexture({
            size: [canvasRef.width, canvasRef.height],
            format: 'depth24plus',
