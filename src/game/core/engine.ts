...
import { createBrick, updateBrick, bumpBrick } from "../entities/environment/Brick";
...
import { createMissileShooter, updateMissileShooter, createLaserHazard, updateLaserHazard } from "../entities/hazards/Hazards";
import { createMovingPlatform, updateMovingPlatform, createAcidWater } from "../entities/environment/Environment";
import { createPortal, updatePortal } from "../entities/environment/Portal";
import { createGoal } from "../entities/environment/Goal";
import { createCoin } from "../entities/items/Coin";
