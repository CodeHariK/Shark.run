...
const Foodly: Component = () => {
    ...
    return (
        <div class={styles.foodlyWrapper} style={{ "overflow-y": "auto", height: "100vh" }}>
            <div class={styles.appContainer} style={{ "flex-direction": "column", "gap": "2rem" }}>

                {/* Global Unified Header */}
                <header class={styles.header} style={{ "width": "100%", "padding": "1.5rem 1rem", "z-index": "100", "background": "var(--bg-main)", "position": "sticky", "top": "0" }}>
                    <div class={styles.logo}>FOODLY</div>

                    <nav class={styles.navBar}>
                        <a href="#menu" class={styles.navLinkActive} onClick={(e) => { e.preventDefault(); scrollTo('menu-section'); }}>
                            Menu Showcase
                        </a>
                        <a href="#orders" class={styles.navLink} onClick={(e) => { e.preventDefault(); scrollTo('orders-section'); }}>
                            Orders Dashboard
                        </a>
                    </nav>
                ...
                {/* Sections Stack */}
                <div id="menu-section" style={{ "width": "100%" }}>
                    <FoodlyMenuSection />
                </div>

                <div id="orders-section" style={{ "width": "100%", "padding-bottom": "5rem" }}>
                    <FoodlyOrders />
                </div>
...
const FoodlyMenuSection: Component = () => {
    const categories = [
            ...
            <main class={styles.mainContent}>
                ...
                <section class={styles.hero}>
                    <div class={styles.heroImageWrap}>
                        <img alt="Rotini Delight" class={styles.heroImage} src="https://lh3.googleusercontent.com/aida-public/AB6AXuD2N2rIa-O6aG4NQwnIi5z-mwcD58yHQ9m73gaZkOuVd6POj5esPLVRQ4Ygy3rGtBNA1z_RZpm9iXNu7NCKS3X9WRQV7Ain3mmbUbUaBbNMMDvU1w_ar0yYTOMIF-o1btrCQ4V1Utt7ctkh4uunK7ufI7_IaRdX4LDjbavAOzEOruArvrzIzZdhSyVnY1lVHXe-teHTcysz_djQ788ql4xZcJjdz49gfenUF1YTd6z-s5eP5DHlZXQpPQwTLRGoGR8rKqCMgzMK3EI" />
                    </div>
